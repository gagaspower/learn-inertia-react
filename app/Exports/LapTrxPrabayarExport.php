...
class LaptrxPrabayarExport implements FromQuery, WithHeadings, WithMapping, WithEvents
{
    ...
    public function query()
    {
        ...
        return TransactionPrabayar::with(['productPrepaid', 'user'])
                   ->whereHas('productPrepaid', function ($query) use ($cat) {
                       if ($cat && $cat !== 'all') {
    ...
    public function headings(): array
    {
        ...
        if ($user->hasRole('Admin')) {
            return ['KODE TRANSAKSI', 'NO/ID PELANGGAN', 'PRODUK', 'KATEGORI PRODUK', 'BRAND PRODUK', 'HARGA DIGIFLAZ', 'HARGA JUAL', 'STATUS TRANSAKSI', 'SOURCE TRANSAKSI', 'USER', 'SN'];
        } else {
            return ['KODE TRANSAKSI', 'NO/ID PELANGGAN', 'PRODUK', 'KATEGORI PRODUK', 'BRAND PRODUK', 'HARGA', 'STATUS TRANSAKSI', 'SOURCE TRANSAKSI', 'SN'];
        }
    }
    ...
    public function map($product): array
    {
        ...
        if ($user->hasRole('Admin')) {
            return [
                ...
                $product->transaction_customer_no,
                $product->productPrepaid->product_name,
                $product->transaction_product_category,
                $product->transaction_product_brand,
                $product->productPrepaid->product_cost,
                $product->productPrepaid->product_price,
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                $snColumn   = Auth::user()->hasRole('Admin') ? 'K' : 'I';
