...
export default function Edit() {
    const { flash, data: currentData } = usePage().props;

    const { data, setData, put, errors, processing } = useForm({
        id: currentData.id || "",
        nama_layanan: currentData.nama_layanan || "",
        deskripsi_layanan: currentData.deskripsi_layanan || "",
        harga_layanan: currentData.harga_layanan || "",
    });
    ...
    const handleSubmitForm = (e) => {
        e.preventDefault();
        put(route("layanan.update", { id: data.id }));
    };
    return (
        <Cards>
            <div className="p-4">
                <div className="border-b py-3 mb-3">
                    <span>Edit Data Layanan</span>
                </div>
