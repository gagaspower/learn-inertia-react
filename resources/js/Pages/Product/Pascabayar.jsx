...
export default function Pascabayar() {
    ...
    const columnsforAdmin = useMemo(
        () => [
            ...
            {
                key: "product_admin_formatted",
                label: "Biaya admin",
            },
            {
                key: "product_commision_formatted",
                label: "Komisi",
            },
        ],
        []
    ...
    const getData = (param = {}, preserveState = true) => {
        router.get(route("product.pascabayar"), param, {
            replace: true,
            preserveState,
            only: ["products"],
        });
    ...
    const handleImport = () => {
        router.visit(route("digiflaz.import_product_pascabayar"));
    };
    ...
    const handleDownloadFile = () => {
        window.location.href = route("product.pascabayar.download");
    };
